...
storyData.franny = {
    ...
    callZooey: {
        ...
        quote: `In going ahead with the Jesus Prayer—just let me finish, now, please—in going ahead with the Jesus Prayer, aren’t you trying to lay up some kind of treasure? Something that’s every goddam bit as negotiable as all those other, more material things? (Salinger, 125).`,
    },
    askZooey: {
    ...
    returnChanged: {
        ...
        lesson: "Abandonment of repentance may contribute to the most necessary change. Here, that is Franny seeing she must embody the Jesus Prayer instead of blindly reciting it.",
        choices: [],
    },
};
